...
export default function TranslatorKorean({ onCardAdded }: KoreanTranslatorProps) {
    ...
    const [modifiedTranslatedText, setModifiedTranslatedText] = useState<string | null>(null);
    ...
    const addToCard = async (originalText: string, translatedText: string) => {
        await addTranslationCard(originalText, translatedText);
        onCardAdded?.();
    };
    ...
    return (
        <View style={styles.container}>
            <View style={styles.realtimeContainer}>
                <ThemedText size="md" weight="semibold">{isRealtime ? 'Real-time' : 'Manual'} Translation</ThemedText>
                <Switch
                    value={isRealtime}
